...
for image_name in train_data['photo_id']:
    image = Image.open(r'D:\Yelp\restaurant_photos\\' + image_name + '.jpg', 'r')
...
train_data.to_pickle(r'C:\Users\crobe\Google Drive\DataMiningGroup\Datasets\train_labels_.pkl')
...
test_data.to_pickle(r'C:\Users\crobe\Google Drive\DataMiningGroup\Datasets\test_labels_.pkl')
