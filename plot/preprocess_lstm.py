...
input_path = r'C:\Users\crobe\Google Drive\DataMiningGroup\Results\LSTM\second'
...
result_df.to_csv(input_path + r'\results.csv')
result_df.to_excel(input_path + r'\results.xlsx')
