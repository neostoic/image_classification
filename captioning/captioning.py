...
def captioning():
    global MEAN_VALUES, SEQUENCE_LENGTH, MAX_SENTENCE_LENGTH, index_to_word, BATCH_SIZE, f
    ...
    with open('./data/results_yelp_webpage.json', 'w') as outfile:
    ...
    with open(r'./data/captions_yelp_nic_results_webpage.json', 'w') as outfile:
