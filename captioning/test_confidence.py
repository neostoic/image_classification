...
# images in the dataset and creates a new JSON file that contains the predicted captions. For each iteration, we evaluate
# the BLEU-4 score and confidence score.
